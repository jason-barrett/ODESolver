...
import us.jasonbarrett.odesolver.method.Order4RungeKuttaMethod;
...
public class TestOrder4RungeKuttaMethod {
    /*
    ...
    */
    ...
    @Test
    public void testOrder4RungeKuttaStep() {
        Order4RungeKuttaMethod order4RungeKuttaMethod = new Order4RungeKuttaMethod();

        StepResult result = order4RungeKuttaMethod.step(initialCond,
