...
import us.jasonbarrett.odesolver.method.AdaptiveTrapezoidalMethod;
...
public class TestAdaptiveTrapezoidalMethod {
    /*
    ...
    */
    ...
    @Test
    public void testAdaptiveTrapezoidalStep() {
        AdaptiveTrapezoidalMethod adaptiveTrapezoidalMethod = new AdaptiveTrapezoidalMethod();

        StepResult result = adaptiveTrapezoidalMethod.step(initialCond,
