...
import us.jasonbarrett.odesolver.method.TrapezoidalMethod;
...
public class TestTrapezoidalMethod {
    /*
 ...
 */
    ...
    @Test
    public void testTrapezoidalStep() {
        TrapezoidalMethod trapezoidalMethod = new TrapezoidalMethod();

        StepResult result = trapezoidalMethod.step(initialCond,
